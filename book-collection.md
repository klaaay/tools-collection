...
[深入理解 TypeScript(中文)](https://jkchao.github.io/typescript-book-chinese/project/compilationContext.html#tsconfig-json)  
[深入理解 TypeScript(英文)](https://basarat.gitbooks.io/typescript/content/docs/getting-started.html)
...
[CSS COOKBOOK](https://developer.mozilla.org/en-US/docs/Web/CSS/Layout_cookbook)
